...
적외선거리센서확인:
    ...
    IF 적외선거리값 > 70 THEN '50 = 적외선거리값 = 25cm
        MUSIC "C"
        ETX  4800,99
        ETX  4800,99
        DELAY 200
...
우유종종걸음:
    ...
    MOVE G6A,95,  74, 145,  93, 101
    MOVE G6D,101,  74, 145,  93, 98
    WAIT

    MOVE G6D,104,  74, 147,  93,  102
    MOVE G6A,95,  93, 120, 95, 104
    WAIT

    MOVE G6A, 103,  77, 147,  89, 100
    MOVE G6D,95,   62, 147, 103,  102
    WAIT

    MOVE G6D,95,  74, 145,  93, 101
    MOVE G6A,101,  74, 145,  93, 98
    WAIT

    MOVE G6A,104,  74, 147,  93,  102
    MOVE G6D,95,  93, 120, 95, 104
    WAIT

    MOVE G6D, 103,  77, 147,  89, 100
    MOVE G6A,95,   63, 147, 103,  102
    WAIT
...
집고후진걸음2:
    ...
    MOVE G6A,95,  95, 110, 92, 104
    WAIT

    MOVE G6A,95,  90, 125, 82, 104
...
KEY45:
    ...
    ETX 4800, 45
    MOVE G6A, 100, 115,  70, 150, 100,
    MOVE G6D, 100, 115,  70, 150, 100,
    MOVE G6B, 150,  31,  80,  ,  ,
    MOVE G6C, 150,  31,  80,  ,  ,

    MOVE G6A, 100, 135,  40, 150, 100,
    MOVE G6D, 100, 135,  40, 150, 100,


    MOVE G6A, 100, 135,  40, 160, 100,
    MOVE G6D, 100, 135,  40, 160, 100,
    ...
    DELAY 1000
    SPEED 3
    MOVE G6A, 100, 120,  40, 160, 100,
    MOVE G6D, 100, 120,  40, 160, 100,
